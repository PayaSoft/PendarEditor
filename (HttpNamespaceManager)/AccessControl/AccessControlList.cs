...
namespace HttpNamespaceManager.Lib.AccessControl
{
    ...
    ///     Access Control List
    /// </summary>
    internal sealed class AccessControlList : IList<AccessControlEntry>
    {
        #region Constants
        ...
        /// <summary>
        ///     Gets the number of <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" /> items in the Access
        ///     Control List
        /// </summary>
        public int Count
        {
        ...
        {
            Regex aclRegex = new Regex(aclExpr, RegexOptions.IgnoreCase);
            ...
            {
                Regex aceListRegex = new Regex(aceListExpr);
        ...
        /// <summary>
        ///     Clears all <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" /> items from the Access Control
        ///     List
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        ///     Checks if an <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" /> exists in the Access Control
        ///     List
        /// </summary>
        ...
        /// <summary>
        ///     Copies all <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" /> items from the Access Control
        ///     List to an Array
        /// </summary>
        ...
        /// <summary>
        ///     Gets an Enumerator over all <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" /> items in the
        ///     Access Control List
        /// </summary>
        ...
        /// <param name="item">The <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" /></param>
        /// <returns>
        ///     The index of the <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" />, or -1 if the Access
        ...
        /// <returns>
        ///     true if the <see cref="HttpNamespaceManager.Lib.AccessControl.AccessControlEntry" /> was found and removed,
        ///     otherwise false
        /// </returns>
        ...
        {
            return ((IEnumerable) this.aceList).GetEnumerator();
        }
