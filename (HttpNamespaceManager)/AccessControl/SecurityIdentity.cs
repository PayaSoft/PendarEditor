...
namespace HttpNamespaceManager.Lib.AccessControl
{
    ...
    internal class SecurityIdentity
    {
        ...
        private static readonly string[] wellKnownSidAbbreviations =
        {
            "",
            "WD",
            "",
        ...
        /// </summary>
        /// <remarks>The table indicies correspond to <see cref="WELL_KNOWN_SID_TYPE" />s</remarks>
        private static readonly string[] wellKnownSids =
        {
            "S-1-0-0", // NULL SID
            "S-1-1-0", // Everyone
            "S-1-2-0", // LOCAL
        ...
        public static SecurityIdentity SecurityIdentityFromWellKnownSid(WELL_KNOWN_SID_TYPE sidType)
        {
            ...
            uint size = GetSidLengthRequired(SID_MAX_SUB_AUTHORITIES);
            ;
        ...
        {
            if (this.IsWellKnownSid && !string.IsNullOrEmpty(wellKnownSidAbbreviations[(int) this.wellKnownSidType]))
            {
                return wellKnownSidAbbreviations[(int) this.wellKnownSidType];
            }
            return this.SID;
        }
