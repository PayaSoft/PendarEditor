...
namespace Paya.Automation.Editor.Data
{
    ...
    [SuppressMessage("Microsoft.Design", "CA1001:TypesThatOwnDisposableFieldsShouldBeDisposable", Justification = "WPF Compatability")]
    [SuppressMessage("Microsoft.Design", "CA1010:CollectionsShouldImplementGenericInterface", Justification = "WPF Compatibility")]
    [SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix", Justification = "WPF Compatibility for naming")]
    public sealed class PagedCollectionView : ICollectionView, IPagedCollectionView, IEditableCollectionView, INotifyPropertyChanged
    {
        ...
        public PagedCollectionView(IEnumerable source, bool isDataSorted, bool isDataInGroupOrder)
        {
            ...
            var sourceCollection = source as ICollection<object> ?? source.Cast<object>().ToArray();
            ...
            this._group.GroupDescriptions.CollectionChanged += this.OnGroupByChanged;

            this.CopySourceToInternalList();
            this._trackingEnumerator = sourceCollection.GetEnumerator();
            ...
            {
                ((INotifyCollectionChanged) source).CollectionChanged += delegate (object sender, NotifyCollectionChangedEventArgs args) { this.ProcessCollectionChanged(args); };
            }

            //this.PropertyChanged += this.PagedCollectionView_PropertyChanged;
        }
        ...
        public int Count
        {
            get
            {
                ...
                if (this.IsGrouping)
                {
                    return this._isUsingTemporaryGroup ? this._temporaryGroup.ItemCount : this._group.ItemCount;
                }
        ...
        public object CurrentEditItem
        {
            ...
            private set
            {
                if (this._editItem != value)
                {
                    ...
                    var oldCanCancelEdit = this.CanCancelEdit;
        ...
        /// </summary>
        private IList InternalList { get; set; }
        ...
        public object AddNew()
        {
            ...
            if (removeIndex > -1)
            {
                var removeItem = this.GetItemAt(removeIndex);
                if (this.IsGrouping)
                {
            ...
            this.InternalList.Insert(this.ConvertToInternalIndex(addIndex), newItem);
        ...
        public void CancelEdit()
        {
            ...
            var ieo = editItem as IEditableObject;
            if (ieo != null)
            {
                ieo.CancelEdit();
            }
        ...
        public void CancelNew()
        {
            ...
            var index = this.IndexOf(this.CurrentAddItem);
            ...
            if (this.CurrentAddItem != null)
            {
                ...
                if (addIndex > -1)
                {
                    var internalIndex = this.ConvertToInternalIndex(addIndex);
                    object addItem;
                    if (this.IsGrouping)
                    {
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "Handles multiple input types and scenarios")]
        public void CommitEdit()
        {
            ...
            if (this.UsesLocalArray)
            {
                ...
                var removeIndex = this.IndexOf(editItem);
                var internalRemoveIndex = this.InternalIndexOf(editItem);
                this.InternalList.Remove(editItem);

                // check whether to restore currency to the item being edited
                var restoreCurrencyTo = (editItem == this.CurrentItem) ? editItem : null;
                ...
                var passedFilter = this.PassesFilter(editItem);
                ...
                var pageStartIndex = this.PageIndex * this.PageSize;
                var nextPageStartIndex = pageStartIndex + this.PageSize;
                ...
                if (this.IsGrouping)
                {
                       ...
                       (pageStartIndex <= leafIndex && nextPageStartIndex > leafIndex)))
                    {
                        ...
                        var addIndex = this.IndexOf(editItem);
                    ...
                    else if (this.PageSize > 0)
                    {
                        ...
                        var addItem = this._temporaryGroup.LeafAt(addIndex);
                        if (addItem != null)
                        {
                            this._group.AddToSubgroups(addItem, false /*loading*/);
                ...
                else
                {
                    ...
                    else if (this.PageSize > 0)
                    {
                        ...
                        var insertedToPreviousPage = this.PassesFilter(editItem) &&
        ...
        public void CommitNew()
        {
            ...
            var previousCurrentItem = this.CurrentItem;
            ...
            if (this.UsesLocalArray)
            {
                ...
                var internalIndex = this.InternalList.IndexOf(newItem);
                this.InternalList.Remove(newItem);
                ...
                // check to see that the item will be added back in
                var passedFilter = this.PassesFilter(newItem);
                ...
                if (this.IsGrouping)
                {
                       ...
                       (pageStartIndex <= leafIndex && nextPageStartIndex > leafIndex)))
                    {
                        ...
                        var addIndex = this.IndexOf(newItem);
                        ...
                        {
                            this.AdjustCurrencyForAdd(this.Contains(previousCurrentItem) ? previousCurrentItem : this.GetItemAt(this.Count - 1), addIndex);
                        }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var insertedToPreviousPage = this.InternalIndexOf(newItem) < this.ConvertToInternalIndex(0);
                            addIndex = insertedToPreviousPage ? 0 : this.Count - 1;
        ...
        public void EditItem(object item)
        {
            ...
            if (this.IsAddingNew)
            {
                if (Equals(item, this.CurrentAddItem))
                {
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            if (this.PageSize > 0)
            {
                ...
                for (var index = this._pageSize * this.PageIndex;
                    index < Math.Min(this._pageSize * (this.PageIndex + 1), this.InternalList.Count);
                    index++)
                {
        ...
        public int IndexOf(object item)
        {
            ...
            if (this.IsAddingNew && Equals(item, this.CurrentAddItem) && this.UsesLocalArray)
            {
                return this.Count - 1;
            }

            var internalIndex = this.InternalIndexOf(item);
        ...
        public bool MoveCurrentTo(object item)
        {
            ...
            if (Equals(this.CurrentItem, item))
            {
        ...
        public bool MoveCurrentToNext()
        {
            ...
            return index <= this.Count && this.MoveCurrentToPosition(index);
        }
        ...
        public bool MoveCurrentToPrevious()
        {
            ...
            return index >= -1 && this.MoveCurrentToPosition(index);
        }
        ...
        public void Refresh()
        {
            var ecv = this as IEditableCollectionView;
        ...
        public void RemoveAt(int index)
        {
            ...
            var replaceItem = this.PageSize > 0 && !this.OnLastLocalPage;
            ...
            if (replaceItem)
            {
                ...
                if (this.IsGrouping)
                {
                    var newItem = this._temporaryGroup.LeafAt((this.PageSize * (this.PageIndex + 1)) - 1);
                    if (newItem != null)
                    {
                        this._group.AddToSubgroups(newItem, false /*loading*/);
                    }
        ...
        {
            Exception exception;
            var propertyValue = TypeHelper.GetNestedPropertyValue(item, propertyPath, propertyType, out exception);
            if (exception != null)
            {
                throw exception;
            }
        ...
        ///// <summary>
        ///// Handles the PropertyChanged event of the PagedCollectionView control.
        ///// </summary>
        ...
        private void AdjustCurrencyForAdd(object newCurrentItem, int index)
        {
            ...
            {
                var newItemIndex = this.IndexOf(newCurrentItem);
        ...
        {
            var newItem = this.CurrentAddItem;

            this.CurrentAddItem = null;    // leave "adding-new" mode

            var ieo = newItem as IEditableObject;
            if (ieo != null)
            {
                if (cancel)
                {
        ...
        private Type GetItemType(bool useRepresentativeItem)
        {
            ...
            foreach (var typeParameters in interfaces.Where(interfaceType => interfaceType.Name == typeof(IEnumerable<>).Name).Select(interfaceType => interfaceType.GetGenericArguments()).Where(typeParameters => typeParameters.Length == 1))
            {
            ...
            if (useRepresentativeItem)
            {
                ...
                var item = this.GetRepresentativeItem();
                if (item != null)
                {
                    return item.GetType();
                }
        ...
        private void PrepareGroupingComparer(CollectionViewGroupRoot groupRoot)
        {
            ...
            {
                var listComparer = groupRoot.ActiveComparer as CollectionViewGroupInternal.ListComparer;
        ...
        private void PrepareGroups()
        {
            ...
            {
                for (int num = 0, count = this.InternalList.Count; num < count; ++num)
                {
                    var item = this.InternalList[num];
                    if (item != null && (!this.IsAddingNew || !Equals(this.CurrentAddItem, item)))
                    {
        ...
        private void PrepareTemporaryGroups()
        {
            ...
            foreach (var gd in this._group.GroupDescriptions)
            {
        ...
        private IList PrepareLocalArray(IEnumerable enumerable)
        {
            ...
            var localList = enumerable.Cast<object>().Where(item => this.Filter == null || this.PassesFilter(item)).ToList();
        ...
        private void ProcessAddEvent(object addedItem, int addIndex)
        {
            ...
            var addedIndex = this.IndexOf(addedItem);
            ...
            else if (this.PageSize > 0)
            {
                ...
                var internalIndex = this.IsGrouping ? this._group.LeafIndexOf(addedItem) : this.InternalIndexOf(addedItem);
        ...
        private void ProcessCollectionChanged(NotifyCollectionChangedEventArgs args)
        {
            ...
            var addedItem = (args.NewItems != null) ? args.NewItems[0] : null;
            var removedItem = (args.OldItems != null) ? args.OldItems[0] : null;
        ...
        private void ProcessRemoveEvent(object removedItem, bool isReplace)
        {
            ...
            var removeIndex = this.IndexOf(removedItem);
            ...
            var needToRemove = (this.PageSize == 0 && removeIndex >= 0) || (internalRemoveIndex < (this.PageIndex + 1) * this.PageSize);
        ...
        private void ProcessInsertToCollection(object item, int index)
        {
            ...
            if (this.Filter == null || this.PassesFilter(item))
            {
                if (this.SortDescriptions.Count > 0)
                {
                    ...
                    var sortFieldComparer = new SortFieldComparer(this);
                    ...
                    {
                        index = sortFieldComparer.FindInsertIndex(item, this.InternalList);
                    }
                }
        ...
        private void RefreshOverride()
        {
            ...
            if (this.UsesLocalArray)
            {
                try
                {
                    ...
                    this.InternalList = this.PrepareLocalArray(this._sourceCollection);
        ...
        private void ResetCurrencyValues(object oldCurrentItem, bool oldIsCurrentBeforeFirst, bool oldIsCurrentAfterLast)
        {
            ...
            else
            {
                ...
                var newPosition = this.IndexOf(oldCurrentItem);
        ...
        private void SetSortDescriptions(SortDescriptionCollection descriptions)
        {
            if (this._sortDescriptions != null)
            {
                ((INotifyCollectionChanged)this._sortDescriptions).CollectionChanged -= this.SortDescriptionsChanged;
            }
        ...
        private List<object> SortList(List<object> list)
        {
            ...
            var seq = (IEnumerable<object>)list;
            IComparer<object> comparer = new CultureSensitiveComparer(this.Culture);

            foreach (var sort in this.SortDescriptions)
            {
                var propertyPath = sort.PropertyName;
                Type propertyType = (from item in list where item != null select item.GetType().GetNestedPropertyType(propertyPath)).FirstOrDefault();

                // find the propertyType from the first non-null instance
                // in the list

                var orderedEnum = seq as IOrderedEnumerable<object>;

                switch (sort.Direction)
                {
                    case ListSortDirection.Ascending:
                        seq = orderedEnum != null ? orderedEnum.ThenBy(item => InvokePath(item, propertyPath, propertyType), comparer) : seq.OrderBy(item => InvokePath(item, propertyPath, propertyType), comparer);

                        break;
                    case ListSortDirection.Descending:
                        seq = orderedEnum != null ? orderedEnum.ThenByDescending(item => InvokePath(item, propertyPath, propertyType), comparer) : seq.OrderByDescending(item => InvokePath(item, propertyPath, propertyType), comparer);
        ...
        private class CultureSensitiveComparer : IComparer<object>
        {
            ...
            public int Compare(object x, object y)
            {
                ...
                if (sx != null && sy != null)
                {
                    return this._culture.CompareInfo.Compare(sx, sy);
                }
        ...
        internal class SortFieldComparer : IComparer
        {
            ...
            {
                this.SortFields = collectionView.SortDescriptions;
                this._fields = CreatePropertyInfo(this.SortFields);
            ...
            public int Compare(object x, object y)
            {
                ...
                for (var k = 0; k < this._fields.Length; ++k)
                {
                    ...
                    var propertyType = this._fields[k].PropertyType;
                    ...
                    var v1 = this._fields[k].GetValue(x);
                    var v2 = this._fields[k].GetValue(y);
                    ...
                    else
                    {
                        ...
                        var comparer = this._fields[k].Comparer;
            ...
            public int FindInsertIndex(object x, IList list)
            {
                ...
                while (min <= max)
                {
                    ...
                    var result = this.Compare(x, list[index]);
                    if (result == 0)
                    {
                        return index;
                    }
            ...
            {
                var fields = new SortPropertyInfo[sortFields.Count];
                for (var k = 0; k < sortFields.Count; ++k)
                {
            ...
            struct SortPropertyInfo
            {
                ...
                internal object GetValue(object o)
                {
                    ...
                    {
                        value = InvokePath(o, this.PropertyPath, this.PropertyType);
                    }
            ...
            public SortDescriptionCollection SortFields { get; private set; }
